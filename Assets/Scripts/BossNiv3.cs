...
public class BossNiv3 : MonoBehaviour
{
    ...
    void Start()
    {
        InvokeRepeating("ChoixAttaque", 0f, 2f); //répéter la fonction d'attaque après 0 secondes et 2 secondes d'interval
    }
    ...
    void ChoixAttaque()
    {
        ...
        if (etatBoss == 2 || etatBoss == 3 && attaque1 == false && GetComponent<VieDommageNiv3>().estMort == false) //si étatBos est == à 2 ou à 3 et qu'il n'est pas mort...
        {
            ...
            Invoke("ArretAttaque1", 0.8f); //invoquer l'arret de l'attaque apres 0.8 secondes
            GetComponent<Animator>().SetBool("blesser", false); //activer l'animation d'attaque 1
        }

        else if (etatBoss == 4 && attaque2 == false && GetComponent<VieDommageNiv3>().estMort == false) //si étatBos est == à 4 et qu'il n'est pas mort...
        {
            attaque2 = true; //activer l'animation d'attaque 2
            GetComponent<Animator>().SetBool("attaque2", true); //activer l'animation d'attaque 2
            Invoke("ArretAttaque2", 0.8f); //invoquer l'arret de l'attaque apres 0.8 secondes
            GetComponent<Animator>().SetBool("blesser", false); //activer l'animation d'attaque 1
        }
    }
