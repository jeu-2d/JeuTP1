...
public class ControlerPersonnage : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D InfoCollision)
    {
        ...
        if (InfoCollision.gameObject.name == "MonstreVolant" && !attaque) //si il y a une collision entre le monstre et attaque est false
        {
        ...
        if (InfoCollision.gameObject.name == "Boss" && leBoss.GetComponent<BossNiv1>().attaque1 == true) //si il y a une collision entre le monstre et attaque est false
        {
        ...
        if (InfoCollision.gameObject.name == "Boss" && leBoss.GetComponent<BossNiv1>().attaque2 == true) //si il y a une collision entre le monstre et attaque est false
        {
         ...
         if (InfoCollision.gameObject.name == "Portail") //quand le personnage touche le portail le niveau 2 est lancé 
         {
             Invoke("LancerNiveau2", 0f);
         }
    }
...
void ArretAttaque() // fonction pour arreter l'attaque
    ...
    void LancerNiveau2() //fonction pour lancer le niveau 2
    {
