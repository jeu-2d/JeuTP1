...
public class VieDommageNiv3 : MonoBehaviour
{
    public int vieMax = 300; // valeur pour la vie maximum
    ...
    void Update()
    {
        ...
        if (vieActuelle <= 0) // si la vie actuelle est égal à zéro
        {
            ...
            Destroy(gameObject, 1f); //le gameObject mechant est detruit apres l'animation
            Invoke("rouleauApparition", 0.6f); //appeler la fonction pour faire apparaitre le rouleau
        }
